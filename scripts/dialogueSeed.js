...
const WORDS = [
  ...
  // ── Difficulty 2 action verbs ──────────────────────────────────────────
  // Seeded 2026-08-15 (ad hoc, no task file). NOT YET REACHABLE through the
  // live app: category3Service.js's fetchCat3WordsWithProgress() hardcodes
  // `difficulty: 1` as the only word source for all Cat3 screens, and
  // Level1OverviewScreen.js routes 'abilities' through that Cat3-only
  // getNextWord (not the generic dialogueApi one), so these rows will sit
  // in the DB unreachable — same reason 'Can you...?'/'Yes, I can'/
  // "No, I can't"/'I can.......' were never reachable either before being
  // removed from this file entirely (2026-08-15/16, not taught in any form).
  // This is deliberate — wiring an actual difficulty-2 Cat3 flow is a
  // separate, larger change (service word-source query + Cat3 Phase 1/2/3
  // screens + asset maps). Tracked in tasks/TASK-42-wire-abilities-difficulty2.md.
  {
    word: 'Brush',
    category: 'abilities',
    difficulty: 2,
    ...
    keyword_triggers: {
      target: 'Brush',
      score3: ['brush', 'brushing', 'brushes'],
      score2: ['brash', 'brsh', 'bruch'],
      score1: ['bru', 'ush', 'rush'],
    },
  },
  {
    ...
    keyword_triggers: {
      target: 'Wash',
      score3: ['wash', 'washing', 'washes'],
      score2: ['wosh', 'wach', 'wsh'],
      score1: ['wa', 'ash', 'wos'],
    },
  },
  {
  ...
  },
  {
    ...
    keyword_triggers: {
      target: 'Drink',
      score3: ['drink', 'drinking', 'drinks'],
      score2: ['drin', 'dringk', 'dink'],
      score1: ['dri', 'ink', 'rink'],
    },
  },
  {
    ...
    keyword_triggers: {
      target: 'Write',
      score3: ['write', 'writing', 'writes'],
      score2: ['rite', 'ryte', 'wryt'],
      score1: ['wri', 'ite', 'rit'],
    },
  },
  {
    ...
    keyword_triggers: {
      target: 'Play',
      score3: ['play', 'playing', 'plays'],
      score2: ['ply', 'plai', 'pway'],
      score1: ['pla', 'lay', 'ay'],
    },
  },
  {
    ...
    keyword_triggers: {
      target: 'Sleep',
      score3: ['sleep', 'sleeping', 'sleeps'],
      score2: ['slip', 'sleap', 'sleeb'],
      score1: ['sle', 'eep', 'lip'],
    },
  },
  {
    ...
    keyword_triggers: {
      target: 'Watch',
      score3: ['watch', 'watching', 'watches'],
      score2: ['woch', 'wach', 'wotch'],
      score1: ['wat', 'och', 'wa'],
    },
  },
];
